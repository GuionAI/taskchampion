...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.54/TaskChampionFFIFFI.xcframework.zip",
            checksum: "11006c9f9958e61f6ec4c243d5e04a3c9bada418eaa3b7da4a6ab6ae22cba4d8"
        ),
    ]
)
