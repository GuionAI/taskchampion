...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.11/TaskChampionFFIFFI.xcframework.zip",
            checksum: "4006578361329c10edd9522d9f30e80c78002b34a516d40cba310e54dfd6100b"
        ),
    ]
)
