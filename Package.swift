...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.32/TaskChampionFFIFFI.xcframework.zip",
            checksum: "d7f8dc0123a2d8d759a6bde79cf096145bdfbe1be9eea78bc7b80f7c5109b1c7"
        ),
    ]
)
