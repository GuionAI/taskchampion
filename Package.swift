...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.40/TaskChampionFFIFFI.xcframework.zip",
            checksum: "8a57adb1febe7b1a891bc363c671c01b8cacf96af2eeadacf4eb438645e57494"
        ),
    ]
)
