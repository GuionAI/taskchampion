...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.44/TaskChampionFFIFFI.xcframework.zip",
            checksum: "75c43304113f74ef682ddf704fa42ca4fdc3855b3722629339b73755838c31ef"
        ),
    ]
)
