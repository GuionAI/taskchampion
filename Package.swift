...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.24/TaskChampionFFIFFI.xcframework.zip",
            checksum: "96f6c6961bea183166576bb8ab0ac8fca78d248ea7c05300926bced403a4dbac"
        ),
    ]
)
