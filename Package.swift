...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.28/TaskChampionFFIFFI.xcframework.zip",
            checksum: "b71fd612e58972256743f41249ce5865ea3b84bd6c06f402a0c418b5910dfc7a"
        ),
    ]
)
