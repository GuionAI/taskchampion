...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.58/TaskChampionFFIFFI.xcframework.zip",
            checksum: "817051ce2cf193a58c7431193f7d8b9a9f077af9f08297903bdc610ab6acb100"
        ),
    ]
)
