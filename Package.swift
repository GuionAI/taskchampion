...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.34/TaskChampionFFIFFI.xcframework.zip",
            checksum: "92380b1722eded8fca9be9b549019187e1a0a47081d02617b010b39ae9d23c78"
        ),
    ]
)
