...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.29/TaskChampionFFIFFI.xcframework.zip",
            checksum: "b5af7c6977abdaa71c7f9251458de903654e2930bb2c8d858a997f76610d2555"
        ),
    ]
)
