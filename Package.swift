...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.47/TaskChampionFFIFFI.xcframework.zip",
            checksum: "44842d40b10689e9d500c5916dfbd0cf5601e0c476d025d5b011b575a713f835"
        ),
    ]
)
