...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.22/TaskChampionFFIFFI.xcframework.zip",
            checksum: "0b7a64403845b02e9f1a05a37f5a498c5ed5ef0296bfea59a77c807a829b959d"
        ),
    ]
)
