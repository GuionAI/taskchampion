...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.18/TaskChampionFFIFFI.xcframework.zip",
            checksum: "0650c2ba1a0b62025c9e2bce07a16912b95c5f0aa0e9d15a0305aa0936acd589"
        ),
    ]
)
