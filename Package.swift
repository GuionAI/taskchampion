...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.33/TaskChampionFFIFFI.xcframework.zip",
            checksum: "81557844b3620fe2a693d51f38b79ac185e93a695eda30a723a41386f9221cb9"
        ),
    ]
)
