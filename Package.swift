...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.48/TaskChampionFFIFFI.xcframework.zip",
            checksum: "f5a8594d922614d6304c2017f62fae2df021bba0924910276043503f92e4d4a8"
        ),
    ]
)
