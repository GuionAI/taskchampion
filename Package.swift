...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.25/TaskChampionFFIFFI.xcframework.zip",
            checksum: "cb7323002df7c5b1e7f7e6579e9194b1fe2f0040ce18bec0816b1225d2efeee3"
        ),
    ]
)
