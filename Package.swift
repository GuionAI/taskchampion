...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.43/TaskChampionFFIFFI.xcframework.zip",
            checksum: "256838530c01d6519221bbfca81a218056227b6671145488307a3f6fcd41059b"
        ),
    ]
)
