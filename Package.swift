...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.23/TaskChampionFFIFFI.xcframework.zip",
            checksum: "060f787b83ef2221276a9cd05f8203a81928716a2a1daae9f83db4fab16dc353"
        ),
    ]
)
