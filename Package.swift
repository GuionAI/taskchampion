...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.51/TaskChampionFFIFFI.xcframework.zip",
            checksum: "c73ff43e5a078e267edb9c57955acaf5deb3c66b036dbbb20fea32fdecb91391"
        ),
    ]
)
