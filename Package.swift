...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.19/TaskChampionFFIFFI.xcframework.zip",
            checksum: "8714ba31058920169ff89c027bb96d101d2d0284f59c0b8bc315950122fb6499"
        ),
    ]
)
