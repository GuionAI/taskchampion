...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.8/TaskChampionFFIFFI.xcframework.zip",
            checksum: "40d591fe2745643e53c73a2eb0ce0442523bd049d3119b498fd94e1e881a5237"
        ),
    ]
)
