...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.45/TaskChampionFFIFFI.xcframework.zip",
            checksum: "f876fcaad9ad36e8a778850cf7c32ae8b9a3bba339e3b318365a74216c3818da"
        ),
    ]
)
