...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.10/TaskChampionFFIFFI.xcframework.zip",
            checksum: "095cbe91fa0dc9410058670ddd7d31145abeb67f74f2cd519db4fbe6051a9b06"
        ),
    ]
)
