...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.46/TaskChampionFFIFFI.xcframework.zip",
            checksum: "9ffcf190f47fa147fba007e519f61495f36281b7cfddc5db228509a19a259797"
        ),
    ]
)
