...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/GuionAI/taskchampion/releases/download/v3.0.2-guion.55/TaskChampionFFIFFI.xcframework.zip",
            checksum: "588b8e88f2076c3d1dc02a4d802c46f539d28cc9428decc9bf7efcd68e6b5366"
        ),
    ]
)
