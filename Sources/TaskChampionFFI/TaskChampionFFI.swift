...
public protocol FfiSessionProtocol: AnyObject, Sendable {
     ...
     */
    func completeTree(parentUuid: String) async throws  -> [FfiTask]
...
open func clearXstatus(taskUuid: String)async throws  -> FfiTask  {
     ...
     * whole tree completion.
     */
open func completeTree(parentUuid: String)async throws  -> [FfiTask]  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_taskchampion_ffi_fn_method_ffisession_complete_tree(
                    self.uniffiCloneHandle(),
                    FfiConverterString.lower(parentUuid)
                )
            },
            pollFunc: ffi_taskchampion_ffi_rust_future_poll_rust_buffer,
            completeFunc: ffi_taskchampion_ffi_rust_future_complete_rust_buffer,
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_taskchampion_ffi_checksum_method_ffisession_complete_tree() != 28246) {
        return InitializationResult.apiChecksumMismatch
    }
